"""Hedin Bil scraper using BeautifulSoup4 HTML parsing."""
import json
import re
...
_SEARCH_URL = "https://www.hedinbil.se/bilar/begagnade/"
...
class HedinScraper(BaseScraper):
    NAME = "hedin"
    BASE_URL = "https://www.hedinbil.se"
    ...
    async def fetch(self) -> list[dict]:
        ...
        for model in _SEARCH_MODELS:
            page = 1
            while True:
                params = {**_SEARCH_PARAMS, "modell": model, "sida": str(page)}
                cache_key = f"hedin:{model}:page{page}"
        ...
        for item in raw_data:
            try:
                ...
                cards = (
                    ...
                    or soup.select("article.car-listing")
